...
# And This is the some data emulation behind this scikit-learn 
...
train = pd.read_csv('/home/Project/train.csv')
test = pd.read_csv('/homeProject/test.csv')
df = pd.read_csv('/home/Project/submission.csv')
